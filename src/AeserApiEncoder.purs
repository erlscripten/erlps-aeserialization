     ...
     (\ of_3 ->
        case of_3 of
          (ErlangTuple [actualtype_6, dec_7]) ->
            let
              case_8 = (BIF.lists__member__2 [actualtype_6, allowedtypes_0])
            in
              case case_8 of
                (ErlangAtom "true") ->
                  (EXC.tryCatch
        ...
        case ex_4 of
          (ErlangTuple [(ErlangAtom "error"), _, _]) ->
            (ErlangTuple
               [(ErlangAtom "error"), (ErlangAtom "invalid_encoding")])
          ex_5 -> (EXC.raise ex_5)))
erlps__safe_decode__2 [arg_14, arg_15] =
  (EXC.function_clause unit)
...
erlps__check_str__1 [bin_0] =
  ...
  in let match_expr_7 = (erlps__sha256_hash__1 [arg_1])
  in
