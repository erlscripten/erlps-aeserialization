...
erlps__tag__1__p1 [(ErlangAtom "name_commitment")] = toErl 31
erlps__tag__1__p1 [(ErlangAtom "name_claim_tx")] = toErl 32
erlps__tag__1__p1 [(ErlangAtom "name_preclaim_tx")] = toErl 33
erlps__tag__1__p1 [(ErlangAtom "name_update_tx")] = toErl 34
erlps__tag__1__p1 [(ErlangAtom "name_revoke_tx")] = toErl 35
erlps__tag__1__p1 [(ErlangAtom "name_transfer_tx")] = toErl 36
erlps__tag__1__p1 [(ErlangAtom "name_auction")] = toErl 37
erlps__tag__1__p1 [(ErlangAtom "contract")] = toErl 40
erlps__tag__1__p1 [(ErlangAtom "contract_call")] = toErl 41
erlps__tag__1__p1 [(ErlangAtom "contract_create_tx")] = toErl 42
erlps__tag__1__p1 args = erlps__tag__1__p2 args

erlps__tag__1__p2 :: ErlangFun
erlps__tag__1__p2 [(ErlangAtom "contract_call_tx")] = toErl 43
erlps__tag__1__p2 [(ErlangAtom "channel_create_tx")] = toErl 50
erlps__tag__1__p2 [(ErlangAtom "channel_deposit_tx")] = toErl 51
erlps__tag__1__p2 [(ErlangAtom "channel_withdraw_tx")] = toErl 52
...
erlps__tag__1__p2 [(ErlangAtom "channel_close_solo_tx")] =
  toErl 54
erlps__tag__1__p2 [(ErlangAtom "channel_slash_tx")] = toErl 55
erlps__tag__1__p2 [(ErlangAtom "channel_settle_tx")] = toErl 56
erlps__tag__1__p2 [(ErlangAtom "channel_offchain_tx")] = toErl 57
...
erlps__tag__1__p3 [(ErlangAtom "channel_client_reconnect_tx")] =
  toErl 575
erlps__tag__1__p3 [(ErlangAtom "channel")] = toErl 58
erlps__tag__1__p3 [(ErlangAtom "channel_snapshot_solo_tx")] =
  toErl 59
erlps__tag__1__p3 [(ErlangAtom "trees_poi")] = toErl 60
erlps__tag__1__p3 args = erlps__tag__1__p4 args

erlps__tag__1__p4 :: ErlangFun
erlps__tag__1__p4 [(ErlangAtom "trees_db")] = toErl 61
erlps__tag__1__p4 [(ErlangAtom "state_trees")] = toErl 62
erlps__tag__1__p4 [(ErlangAtom "mtree")] = toErl 63
erlps__tag__1__p4 [(ErlangAtom "mtree_value")] = toErl 64
erlps__tag__1__p4 [(ErlangAtom "contracts_mtree")] = toErl 621
erlps__tag__1__p4 [(ErlangAtom "calls_mtree")] = toErl 622
erlps__tag__1__p4 [(ErlangAtom "channels_mtree")] = toErl 623
erlps__tag__1__p4 [(ErlangAtom "nameservice_mtree")] = toErl 624
erlps__tag__1__p4 [(ErlangAtom "oracles_mtree")] = toErl 625
erlps__tag__1__p4 [(ErlangAtom "accounts_mtree")] = toErl 626
erlps__tag__1__p4 args = erlps__tag__1__p5 args

erlps__tag__1__p5 :: ErlangFun
erlps__tag__1__p5 [(ErlangAtom "compiler_sophia")] = toErl 70
erlps__tag__1__p5 [(ErlangAtom "ga_attach_tx")] = toErl 80
erlps__tag__1__p5 [(ErlangAtom "ga_meta_tx")] = toErl 81
erlps__tag__1__p5 [(ErlangAtom "key_block")] = toErl 100
erlps__tag__1__p5 [(ErlangAtom "micro_block")] = toErl 101
erlps__tag__1__p5 [(ErlangAtom "light_micro_block")] = toErl 102
erlps__tag__1__p5 [(ErlangAtom "pof")] = toErl 200
