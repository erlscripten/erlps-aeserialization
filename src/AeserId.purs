...
erlps__create__2 args =
  EXC.badarity (ErlangFun 2 erlps__create__2) args
...
erlps__specialize__1 args =
  EXC.badarity (ErlangFun 1 erlps__specialize__1) args
...
erlps__specialize_type__1 [(ErlangTuple [(ErlangAtom "id"),
  ...
  | ((((((==) tag_0 (ErlangAtom "account")) ||
      ...
      ((==) tag_0 (ErlangAtom "channel")) =
  tag_0
erlps__specialize_type__1 [arg_1] = EXC.function_clause unit
erlps__specialize_type__1 args =
  EXC.badarity (ErlangFun 1 erlps__specialize_type__1) args
...
erlps__is_id__1 args =
  EXC.badarity (ErlangFun 1 erlps__is_id__1) args
...
erlps__encode_tag__1 args =
  EXC.badarity (ErlangFun 1 erlps__encode_tag__1) args
...
erlps__decode_tag__1 args =
  EXC.badarity (ErlangFun 1 erlps__decode_tag__1) args