...
erlps__serialize__4 [tag_0, vsn_1, template_2, fields_3] =
  let    head_5 = ErlangTuple [ErlangAtom "tag", ErlangAtom "int"]
  in let head_9 = ErlangTuple [ErlangAtom "vsn", ErlangAtom "int"]
...
erlps__deserialize__5 [type_0, tag_1, vsn_2, template0_3,
  ...
  let   
    decoded_6 =
      BIF.do_remote_fun_call "Aeser.Rlp" "erlps__decode__1" [binary_4]
  in let head_7 = ErlangTuple [ErlangAtom "tag", ErlangAtom "int"]
  in let head_11 = ErlangTuple [ErlangAtom "vsn", ErlangAtom "int"]
  in let
    case_16 =
      erlps__decode_fields__2
        [ErlangCons head_7 (ErlangCons head_11 template0_3), decoded_6]
  in
    case case_16 of
...
erlps__deserialize_tag_and_vsn__1 [binary_0] =
  let
    matchExpr_5 =
      BIF.do_remote_fun_call "Aeser.Rlp" "erlps__decode__1" [binary_0]
  in
    case matchExpr_5 of
      (ErlangCons tagbin_2 (ErlangCons vsnbin_3 fields_4)) ->
        let    head_6 = ErlangTuple [ErlangAtom "tag", ErlangAtom "int"]
        in let head_10 = ErlangTuple [ErlangAtom "vsn", ErlangAtom "int"]
        in let
          matchExpr_23 =
            erlps__decode_fields__2
       ...
       case ex_9 of
         (ErlangTuple [(ErlangAtom "error"),
           ...
           let
             arg_18 =
               ErlangTuple
                 [ErlangAtom "illegal_field", field_0, type_1, val_4, t_16,
                  v_17]
...
erlps__encode_fields__2 [template_0, values_1] =
  let
    arg_2 =
      ErlangTuple
        [ErlangAtom "illegal_template_or_values", template_0, values_1]
...
erlps__decode_fields__2 [(ErlangCons (ErlangTuple [field_0,
  ...
  EXC.tryOfCatch (\ _ -> erlps__decode_field__2 [type_1, bin_3])
    (\ of_7 ->
       let    head_11 = ErlangTuple [field_0, of_7]
       in let
         tail_14 = erlps__decode_fields__2 [typesleft_2, fieldsleft_4]
       in ErlangCons head_11 tail_14)
    (\ ex_8 ->
       case ex_8 of
         (ErlangTuple [(ErlangAtom "error"),
                       (ErlangTuple [(ErlangAtom "illegal"), t_17, v_18]),
                       _]) ->
           let
             arg_19 =
               ErlangTuple
                 [ErlangAtom "illegal_field", field_0, type_1, bin_3, t_17,
                  v_18]
...
erlps__encode_field__2 [(ErlangCons type_0 (ErlangEmptyList)),
  ...
  flmap
    (\ lc_4 ->
       let lcRet_5 = erlps__encode_field__2 [type_0, lc_4]
  ...
  in
    flmap
      (\ lc_10 ->
         case lc_10 of
           (ErlangTuple [x_8, y_9]) ->
             let lcRet_11 = erlps__encode_field__2 [x_8, y_9]
...
erlps__decode_field__2 [(ErlangCons type_0 (ErlangEmptyList)),
  ...
  flmap
    (\ lc_4 ->
       let lcRet_5 = erlps__decode_field__2 [type_0, lc_4]
       in ErlangCons lcRet_5 ErlangEmptyList)
    list_1
