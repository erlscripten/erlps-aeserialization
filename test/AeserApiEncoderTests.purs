...
erlps__encode_decode_test___0 [] =
  let    tup_el_1 = (make_string "Byte sizes are correct")
  in let
    tup_el_2 =
      (ErlangFun 0
         let
  ...
  in let
    tup_el_89 = (make_string "Serialize/deserialize known types")
  in let
    tup_el_90 =
      (ErlangFun 0
         let
  ...
  in let tup_el_185 = (make_string "Key size check works")
  in let
    tup_el_186 =
      (ErlangFun 0
         let
  ...
  in let tup_el_289 = (make_string "Missing prefix")
  in let
    tup_el_290 =
      (ErlangFun 0
         let
  ...
  in let tup_el_410 = (make_string "Piece of encoded key")
  in let
    tup_el_411 =
      (ErlangFun 0
         let
  ...
  in let
    tup_el_516 = (make_string "Encode/decode binary with only zeros")
  in let
    tup_el_517 =
      (ErlangFun 0
         let
