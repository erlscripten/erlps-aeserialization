             ...
             (EXC.tryOfCatch
                ...
                (\ of_22 ->
                   ...
                   in let
                     head_33 =
                       (ErlangTuple
                          [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 23))])
                   in let
                     tup_el_39 =
                       (H.make_string "serialize ( Template , Values )")
                   in let
                     head_37 =
                       (ErlangTuple [(ErlangAtom "expression"), tup_el_39])
                   in let lop_44 = (H.make_string "{ ")
                   in let lop_46 = (H.make_string "error")
                   in let lop_48 = (H.make_string " , ")
                   in let
                     lop_50 =
                       (H.make_string "{ illegal_field , _ , _ , _ , _ , _ }")
                   in let rop_51 = (H.make_string " , [...] }")
                   ...
                   in let
                     head_41 = (ErlangTuple [(ErlangAtom "pattern"), tup_el_43])
                   in let
                     head_53 =
                ...
                (\ ex_23 ->
                   case ex_23 of
                     ...
                     (ErlangTuple [__c_57, __t_58, __s_59]) ->
                       ...
                       in let lop_78 = (H.make_string "{ ")
                       in let lop_80 = (H.make_string "error")
                       in let lop_82 = (H.make_string " , ")
                       in let
                         lop_84 =
                           (H.make_string
                              "{ illegal_field , _ , _ , _ , _ , _ }")
                       in let rop_85 = (H.make_string " , [...] }")
                       ...
                       in let
                         tup_el_77 = (BIF.erlang__op_append [lop_78, rop_79])
                       in let
                         head_75 =
                           (ErlangTuple [(ErlangAtom "pattern"), tup_el_77])
             ...
             (EXC.tryOfCatch
                ...
                (\ of_33 ->
                   ...
                   in let
                     head_44 =
                       (ErlangTuple
                          [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 33))])
                   in let
                     tup_el_50 =
                       (H.make_string "serialize ( Template , Values )")
                   in let
                     head_48 =
                       (ErlangTuple [(ErlangAtom "expression"), tup_el_50])
                   in let lop_55 = (H.make_string "{ ")
                   in let lop_57 = (H.make_string "error")
                   in let lop_59 = (H.make_string " , ")
                   in let
                     lop_61 =
                       (H.make_string "{ illegal_field , _ , _ , _ , _ , _ }")
                   in let rop_62 = (H.make_string " , [...] }")
                   ...
                   in let
                     head_52 = (ErlangTuple [(ErlangAtom "pattern"), tup_el_54])
                   in let
                     head_64 =
                ...
                (\ ex_34 ->
                   case ex_34 of
                     ...
                     (ErlangTuple [__c_68, __t_69, __s_70]) ->
                       ...
                       in let lop_89 = (H.make_string "{ ")
                       in let lop_91 = (H.make_string "error")
                       in let lop_93 = (H.make_string " , ")
                       in let
                         lop_95 =
                           (H.make_string
                              "{ illegal_field , _ , _ , _ , _ , _ }")
                       in let rop_96 = (H.make_string " , [...] }")
                       ...
                       in let
                         tup_el_88 = (BIF.erlang__op_append [lop_89, rop_90])
                       in let
                         head_86 =
                           (ErlangTuple [(ErlangAtom "pattern"), tup_el_88])
                       in let
                         tup_el_100 = (ErlangTuple [__c_68, __t_69, __s_70])
                       in let
                         head_98 =
                           (ErlangTuple
             ...
             (EXC.tryOfCatch
                ...
                (\ of_50 ->
                   ...
                   in let
                     head_61 =
                       (ErlangTuple
                          [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 43))])
                   in let
                     tup_el_67 =
                       (H.make_string "serialize ( Template , Values )")
                   in let
                     head_65 =
                       (ErlangTuple [(ErlangAtom "expression"), tup_el_67])
                   in let lop_72 = (H.make_string "{ ")
                   in let lop_74 = (H.make_string "error")
                   in let lop_76 = (H.make_string " , ")
                   in let
                     lop_78 =
                       (H.make_string "{ illegal_field , _ , _ , _ , _ , _ }")
                   in let rop_79 = (H.make_string " , [...] }")
                   ...
                   in let
                     head_69 = (ErlangTuple [(ErlangAtom "pattern"), tup_el_71])
                   in let
                     head_81 =
                ...
                (\ ex_51 ->
                   case ex_51 of
                     ...
                     (ErlangTuple [__c_85, __t_86, __s_87]) ->
                       ...
                       in let lop_106 = (H.make_string "{ ")
                       in let lop_108 = (H.make_string "error")
                       in let lop_110 = (H.make_string " , ")
                       in let
                         lop_112 =
                           (H.make_string
                              "{ illegal_field , _ , _ , _ , _ , _ }")
                       in let rop_113 = (H.make_string " , [...] }")
                       in let
                         rop_111 = (BIF.erlang__op_append [lop_112, rop_113])
                       in let
                         rop_109 = (BIF.erlang__op_append [lop_110, rop_111])
                       in let
                         rop_107 = (BIF.erlang__op_append [lop_108, rop_109])
                       in let
                       ...
                       in let
                         tup_el_117 = (ErlangTuple [__c_85, __t_86, __s_87])
                       in let
                         head_115 =
                           (ErlangTuple
             ...
             (EXC.tryOfCatch
                ...
                (\ of_56 ->
                   ...
                   in let
                     head_67 =
                       (ErlangTuple
                          [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 53))])
                   in let
                     tup_el_73 =
                       (H.make_string "serialize ( Template , Values )")
                   in let
                ...
                (\ ex_57 ->
                   case ex_57 of
                     ...
                     (ErlangTuple [__c_91, __t_92, __s_93]) ->
                       ...
                       in let lop_112 = (H.make_string "{ ")
                       in let lop_114 = (H.make_string "error")
                       in let lop_116 = (H.make_string " , ")
                       in let
                         lop_118 =
                           (H.make_string
                              "{ illegal_field , _ , _ , _ , _ , _ }")
                       in let rop_119 = (H.make_string " , [...] }")
                       in let
                         rop_117 = (BIF.erlang__op_append [lop_118, rop_119])
                       in let
                         rop_115 = (BIF.erlang__op_append [lop_116, rop_117])
                       in let
                         rop_113 = (BIF.erlang__op_append [lop_114, rop_115])
                       in let
                       ...
                       in let
                         tup_el_123 = (ErlangTuple [__c_91, __t_92, __s_93])
                       in let
                         head_121 =
                           (ErlangTuple
             ...
             (EXC.tryOfCatch
                ...
                (\ of_63 ->
                   ...
                   in let
                     head_74 =
                       (ErlangTuple
                          [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 63))])
                   in let
                     tup_el_80 =
                       (H.make_string "serialize ( Template , Values )")
                   in let
                     head_78 =
                       (ErlangTuple [(ErlangAtom "expression"), tup_el_80])
                   in let lop_85 = (H.make_string "{ ")
                   in let lop_87 = (H.make_string "error")
                   in let lop_89 = (H.make_string " , ")
                   in let
                     lop_91 =
                       (H.make_string "{ illegal_field , _ , _ , _ , _ , _ }")
                   in let rop_92 = (H.make_string " , [...] }")
                   in let rop_90 = (BIF.erlang__op_append [lop_91, rop_92])
                   ...
                   in let
                     head_82 = (ErlangTuple [(ErlangAtom "pattern"), tup_el_84])
                   in let
                     head_94 =
                ...
                (\ ex_64 ->
                   case ex_64 of
                     ...
                     (ErlangTuple [__c_98, __t_99, __s_100]) ->
                       ...
                       in let lop_119 = (H.make_string "{ ")
                       in let lop_121 = (H.make_string "error")
                       in let lop_123 = (H.make_string " , ")
                       in let
                         lop_125 =
                           (H.make_string
                              "{ illegal_field , _ , _ , _ , _ , _ }")
                       in let rop_126 = (H.make_string " , [...] }")
                       in let
                         rop_124 = (BIF.erlang__op_append [lop_125, rop_126])
                       in let
                         rop_122 = (BIF.erlang__op_append [lop_123, rop_124])
                       in let
                         rop_120 = (BIF.erlang__op_append [lop_121, rop_122])
                       in let
                       ...
                       in let
                         tup_el_130 = (ErlangTuple [__c_98, __t_99, __s_100])
                       in let
                         head_128 =
                           (ErlangTuple
             ...
             (EXC.tryOfCatch
                ...
                (\ of_27 ->
                   ...
                   in let
                     head_38 =
                       (ErlangTuple
                          [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 69))])
                   in let
                     tup_el_44 =
                       (H.make_string
                   ...
                   in let
                     head_42 =
                       (ErlangTuple [(ErlangAtom "expression"), tup_el_44])
                   in let lop_49 = (H.make_string "{ ")
                   in let lop_51 = (H.make_string "error")
                   in let lop_53 = (H.make_string " , ")
                   in let
                     lop_55 =
                       (H.make_string
                          "{ illegal_serialization , _ , _ , _ , _ , _ , _ }")
                   in let rop_56 = (H.make_string " , [...] }")
                   ...
                   in let
                     head_46 = (ErlangTuple [(ErlangAtom "pattern"), tup_el_48])
                   in let
                     head_58 =
                ...
                (\ ex_28 ->
                   case ex_28 of
                     ...
                     (ErlangTuple [__c_62, __t_63, __s_64]) ->
                       ...
                       in let lop_83 = (H.make_string "{ ")
                       in let lop_85 = (H.make_string "error")
                       in let lop_87 = (H.make_string " , ")
                       in let
                         lop_89 =
                           (H.make_string
                              "{ illegal_serialization , _ , _ , _ , _ , _ , _ }")
                       in let rop_90 = (H.make_string " , [...] }")
                       in let rop_88 = (BIF.erlang__op_append [lop_89, rop_90])
                       in let rop_86 = (BIF.erlang__op_append [lop_87, rop_88])
                       in let rop_84 = (BIF.erlang__op_append [lop_85, rop_86])
                       in let
                         tup_el_82 = (BIF.erlang__op_append [lop_83, rop_84])
                       in let
                         head_80 =
                           (ErlangTuple [(ErlangAtom "pattern"), tup_el_82])
             ...
             (EXC.tryOfCatch
                ...
                (\ of_27 ->
                   ...
                   in let
                     head_38 =
                       (ErlangTuple
                          [(ErlangAtom "line"), (ErlangInt (DBI.fromInt 75))])
                   in let
                     tup_el_44 =
                       (H.make_string
